...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_10879 = 0;while(true){
var m_10880 = cljs.core.async.impl.dispatch.tasks.pop();if((m_10880 == null))
{} else
{m_10880.call(null);
if((count_10879 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__10881 = (count_10879 + 1);
count_10879 = G__10881;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3295__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3295__auto__)
