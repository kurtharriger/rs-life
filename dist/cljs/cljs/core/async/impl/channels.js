...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t10885 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t10885 = (function (val,box,meta10886){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t10885.cljs$lang$type = true;
cljs.core.async.impl.channels.t10885.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t10885";
cljs.core.async.impl.channels.t10885.cljs$lang$ctorPrWriter = (function (this__3874__auto__,writer__3875__auto__,opt__3876__auto__){return cljs.core._write.call(null,writer__3875__auto__,"cljs.core.async.impl.channels/t10885");
});
cljs.core.async.impl.channels.t10885.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t10885.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10887){var self__ = this;
var _10887__$1 = this;return self__.meta10886;
});
cljs.core.async.impl.channels.t10885.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10887,meta10886__$1){var self__ = this;
var _10887__$1 = this;return (new cljs.core.async.impl.channels.t10885(self__.val,self__.box,meta10886__$1));
});
cljs.core.async.impl.channels.__GT_t10885 = (function __GT_t10885(val__$1,box__$1,meta10886){return (new cljs.core.async.impl.channels.t10885(val__$1,box__$1,meta10886));
});
}
return (new cljs.core.async.impl.channels.t10885(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3877__auto__,writer__3878__auto__,opts__3879__auto__){return cljs.core._write.call(null,writer__3878__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3874__auto__,writer__3875__auto__,opt__3876__auto__){return cljs.core._write.call(null,writer__3875__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_10888 = self__.takes.pop();if((taker_10888 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_10888))
{var take_cb_10889 = cljs.core.async.impl.protocols.commit.call(null,taker_10888);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_10889,taker_10888){
return (function (){return take_cb_10889.call(null,null);
});})(take_cb_10889,taker_10888))
);
} else
{}
{
