...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3874__auto__,writer__3875__auto__,opt__3876__auto__){return cljs.core._write.call(null,writer__3875__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_10844 = 0;while(true){
if((i_10844 < arr.length))
{(arr[i_10844] = null);
{
var G__10845 = (i_10844 + 1);
i_10844 = G__10845;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3874__auto__,writer__3875__auto__,opt__3876__auto__){return cljs.core._write.call(null,writer__3875__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_10851 = (self__.level + 1);while(true){
if((i_10851 <= (new_level + 1)))
{(update[i_10851] = self__.header);
{
var G__10852 = (i_10851 + 1);
i_10851 = G__10852;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_10853 = 0;while(true){
if((i_10853 <= self__.level))
{var links_10854 = (update[i_10853]).forward;if(((links_10854[i_10853]) === x__$1))
{(links_10854[i_10853] = (x__$1.forward[i_10853]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3307__auto__ = (cljs.core.truth_((function (){var and__3295__auto__ = me;if(cljs.core.truth_(and__3295__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3295__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3307__auto__))
